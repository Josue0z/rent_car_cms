...
class EmailConfirmationScreen extends StatefulWidget {
  ...
  const EmailConfirmationScreen({super.key, required this.usuario});
...
class _EmailConfirmationScreenState extends State<EmailConfirmationScreen> {
  ...
  _initAsync() async {
    try {
      verificacion = Verificacion(email: widget.usuario.usuarioLogin);
      await verificacion?.enviar();
    } catch (e) {
      print(e);
    }
  }
  ...
  _onNext() async {
    try {
      var verificacion = Verificacion(code: code.text);
      showLoader(context);
      await verificacion.verificar();
      Get.back();
